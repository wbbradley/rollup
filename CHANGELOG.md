...
### Changed
- The TUI `c` action now emits focused `gh api` commands for review comments instead of browser permalinks, allowing downstream agents to fetch comment details directly.
