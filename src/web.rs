...
mod tests {
    ...
    #[test]
    fn pr_sections_have_their_own_web_indent_level() {
        assert!(CSS.contains(".pr-subtree>.pr-section{margin-left:1rem}"));
        assert!(CSS.contains(".pr-subtree>.pr-section{margin-left:.45rem}"));
    }
